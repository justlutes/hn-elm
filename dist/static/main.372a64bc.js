...
{
	if (region.an.T === region.av.T)
	{
		return 'on line ' + region.an.T;
	}
	return 'on lines ' + region.an.T + ' through ' + region.av.T;
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try
		{
			xhr.open(request.ad, request.af, true);
		}
		catch (e)
		{
			return callback(_Scheduler_fail(elm$http$Http$BadUrl(request.af)));
		}
...
function _Http_toResponse(xhr)
{
	return {
		af: xhr.responseURL,
		e: { bg: xhr.status, t: xhr.statusText },
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bq: fragment, aB: host, bx: path, aP: port_, aS: protocol, aT: query};
	});
	...
	function (viewerDecoder, config) {
		var init = F3(
			function (flags, url, navKey) {
				...
				return A3(config.aD, maybeViewer, url, navKey);
			});
		return elm$browser$Browser$application(
			{aD: init, aM: config.aM, aN: config.aN, a3: config.a3, a7: config.a7, a8: config.a8});
	});
	...
	return elm$http$Http$request(
		{
			...
			ad: config.ad,
			ae: config.ae,
			af: author$project$Api$Endpoint$unwrap(config.af),
			ah: config.ah
		});
};
...
var elm$http$Http$expectJson = function (decoder) {
	return elm$http$Http$expectStringResponse(
		function (response) {
			var _n0 = A2(elm$json$Json$Decode$decodeString, decoder, response.S);
			if (_n0.$ === 1) {
		...
		return author$project$Api$Endpoint$request(
			{
				...
				aa: elm$http$Http$expectJson(decoder),
				ac: function () {
					if (!maybeCred.$) {
...
var author$project$Article$Internals = F3(
	function (slug, author, metadata) {
		return {_: author, aJ: metadata, a$: slug};
	});
var author$project$Article$Metadata = F6(
	function (description, title, tags, createdAt, favorited, favoritesCount) {
		return {bj: createdAt, bk: description, bn: favorited, bo: favoritesCount, bB: tags, bC: title};
	});
...
var elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {as: col, aQ: problem, aX: row};
	});
var elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3(elm$parser$Parser$DeadEnd, p.aX, p.as, p.aQ);
};
...
var elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {as: col, bi: contextStack, aQ: problem, aX: row};
	});
...
var elm$parser$Parser$Advanced$token = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, str, s.b, s.aX, s.as, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{as: col, c: s0.c, d: s0.d, b: offset, aX: row, a: s0.a});
			} else {
...
var elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5(elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aX, s.as, s);
	};
};
...
var author$project$Article$Comment$Internals = F4(
	function (id, body, createdAt, author) {
		return {_: author, S: body, bj: createdAt, aC: id};
	});
...
var author$project$Page$Article$init = F2(
	function (session, slug) {
		...
		return _Utils_Tuple2(
			{m: author$project$Page$Article$Loading, j: author$project$Page$Article$Loading, H: _List_Nil, am: session, O: elm$time$Time$utc},
...
var author$project$Article$Feed$init = F2(
	function (session, articles) {
		return {D: articles, H: _List_Nil, aG: false, am: session};
	});
...
var author$project$Page$Home$fetchFeed = F3(
	function (session, feedTabs, page) {
		var params = author$project$PaginatedList$params(
			{bw: page, by: author$project$Page$Home$articlesPerPage});
		var maybeCred = author$project$Session$cred(session);
...
var author$project$Page$Home$init = function (session) {
	...
	return _Utils_Tuple2(
		{o: author$project$Page$Home$Loading, ab: 1, I: feedTab, am: session, bB: author$project$Page$Home$Loading, O: elm$time$Time$utc},
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
	...
	function (session, feedTabs, username, page) {
		...
		var params = A2(
			...
			author$project$PaginatedList$params(
				{bw: page, by: author$project$Page$Profile$articlesPerPage}));
...
var author$project$Page$Profile$init = F2(
	function (session, username) {
		...
		return _Utils_Tuple2(
			{
				_: author$project$Page$Profile$Loading(username),
				H: _List_Nil,
				o: author$project$Page$Profile$Loading(username),
				ab: 1,
				I: author$project$Page$Profile$defaultFeedTab,
				am: session,
				O: elm$time$Time$utc
			},
			elm$core$Platform$Cmd$batch(
...
var author$project$Page$Settings$Form = F5(
	function (avatar, bio, email, username, password) {
		return {E: avatar, F: bio, s: email, v: password, x: username};
	});
...
var author$project$Page$Settings$init = function (session) {
	return _Utils_Tuple2(
		{B: _List_Nil, am: session, e: author$project$Page$Settings$Loading},
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
...
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {y: frag, A: params, w: unvisited, q: value, C: visited};
	});
	...
	return A2(
		...
		_Utils_update(
			url,
			{
				...
				bx: A2(elm$core$Maybe$withDefault, '', url.bq)
			}));
};
...
var author$project$Page$Article$subscriptions = function (model) {
	return A2(
		...
		author$project$Session$navKey(model.am));
};
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								m: author$project$Page$Article$Loaded(article)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{m: author$project$Page$Article$Failed}),
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								j: author$project$Page$Article$Loaded(
									_Utils_Tuple2(
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								m: author$project$Page$Article$Loaded(newArticle)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								H: author$project$Api$addServerError(model.H)
							}),
						author$project$Log$error);
				}
			case 6:
					...
					if (_n1.$ === 2) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									m: author$project$Page$Article$Loaded(
										A2(
		...
		var article = elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'title',
					elm$json$Json$Encode$string(form.bC)),
					_Utils_Tuple2(
					'description',
					elm$json$Json$Encode$string(form.bk)),
					_Utils_Tuple2(
					'body',
					elm$json$Json$Encode$string(form.S)),
					_Utils_Tuple2(
					'tagList',
					A2(
						elm$json$Json$Encode$list,
						elm$json$Json$Encode$string,
						author$project$Page$Article$Editor$tagsFromString(form.bB)))
				]));
...
var author$project$Page$Article$Editor$trimFields = function (form) {
	return {
		S: elm$core$String$trim(form.S),
		bk: elm$core$String$trim(form.bk),
		bB: elm$core$String$trim(form.bB),
		bC: elm$core$String$trim(form.bC)
	};
};
...
var author$project$Page$Article$Editor$validateField = F2(
	function (_n0, field) {
		...
		return A2(
			...
			function () {
				if (!field) {
					return elm$core$String$isEmpty(form.bC) ? _List_fromArray(
						['title can\'t be blank.']) : _List_Nil;
				} else {
					return elm$core$String$isEmpty(form.S) ? _List_fromArray(
			...
			case 7:
				if (msg.a.$ === 1) {
					...
					var status = A3(
						...
						_List_Nil,
						{
							S: author$project$Article$Body$toMarkdownString(
								author$project$Article$body(article)),
							bk: description,
							bB: A2(elm$core$String$join, ' ', tags),
							bC: title
						});
					return _Utils_Tuple2(
						_Utils_update(
...
var author$project$PaginatedList$map = F2(
	function (transform, _n0) {
		...
		return _Utils_update(
			info,
			{
				ag: A2(elm$core$List$map, transform, info.ag)
			});
	});
			...
			case 0:
				...
				return _Utils_Tuple2(
					...
					A2(
						elm$core$Task$attempt,
						author$project$Page$Home$CompletedFeedLoad,
						A3(author$project$Page$Home$fetchFeed, model.am, feedTab, 1)));
			case 1:
				var tab = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
					...
					A2(
						elm$core$Task$attempt,
						author$project$Page$Home$CompletedFeedLoad,
						A3(author$project$Page$Home$fetchFeed, model.am, tab, 1)));
			case 2:
				var page = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
					...
					A2(
						...
						A2(
							...
							A3(author$project$Page$Home$fetchFeed, model.am, model.I, page))));
			case 3:
				if (!msg.a.$) {
					var feed = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								o: author$project$Page$Home$Loaded(feed)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{o: author$project$Page$Home$Failed}),
						elm$core$Platform$Cmd$none);
				}
			case 4:
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								bB: author$project$Page$Home$Loaded(tags)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{bB: author$project$Page$Home$Failed}),
						author$project$Log$error);
				}
			case 6:
				var subMsg = msg.a;
				...
				switch (_n2.$) {
					case 2:
						...
						var _n3 = A3(
							...
							author$project$Session$cred(model.am),
							subMsg,
							feed);
						var newFeed = _n3.a;
						var subCmd = _n3.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									o: author$project$Page$Home$Loaded(newFeed)
								}),
	...
	var user = elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'password',
				elm$json$Json$Encode$string(form.v))
			]));
	var body = elm$http$Http$jsonBody(
		elm$json$Json$Encode$object(
			_List_fromArray(
		...
		return A2(
			...
			function () {
				if (!field) {
					...
					return elm$core$String$isEmpty(form.v) ? _List_fromArray(
...
var author$project$Page$Login$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var _n1 = author$project$Page$Login$validate(model.J);
				if (!_n1.$) {
					var validForm = _n1.a;
					return _Utils_Tuple2(
						_Utils_update(
				...
				if (msg.a.$ === 1) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								B: A2(elm$core$List$append, model.B, serverErrors)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var viewer = msg.a.a;
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								_: author$project$Page$Profile$Loaded(newAuthor)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								_: author$project$Page$Profile$Loaded(author)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var _n1 = msg.a.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								_: author$project$Page$Profile$Failed(username)
							}),
						author$project$Log$error);
				}
			case 7:
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								o: author$project$Page$Profile$Loaded(feed)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var _n2 = msg.a.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								o: author$project$Page$Profile$Failed(username)
							}),
						author$project$Log$error);
				}
			case 9:
					...
					case 2:
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									o: author$project$Page$Profile$Loaded(newFeed)
								}),
...
var author$project$Page$Register$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var _n1 = author$project$Page$Register$validate(model.J);
				if (!_n1.$) {
					var validForm = _n1.a;
					return _Utils_Tuple2(
						_Utils_update(
	...
	function (cred, _n0) {
		...
		var updates = _List_fromArray(
			[
				...
				_Utils_Tuple2(
				'bio',
				elm$json$Json$Encode$string(form.F)),
...
var author$project$Page$Settings$trimFields = function (form) {
	return {
		E: elm$core$String$trim(form.E),
		F: elm$core$String$trim(form.F),
		s: elm$core$String$trim(form.s),
		v: elm$core$String$trim(form.v),
		x: elm$core$String$trim(form.x)
	};
				...
				switch (field) {
					...
					case 1:
						return elm$core$String$isEmpty(form.s) ? _List_fromArray(
							['email can\'t be blank.']) : _List_Nil;
					default:
						var passwordLength = elm$core$String$length(form.v);
...
var author$project$Page$Article$favoriteButton = F2(
	function (cred, article) {
		...
		var favoritesCount = _n0.bo;
		var favorited = _n0.bn;
	...
	switch (_n0.$) {
		case 2:
			...
			var buttons = function () {
				var _n4 = author$project$Session$cred(model.am);
				if (!_n4.$) {
					var cred = _n4.a;
													...
													[
														...
														_List_fromArray(
															[
																...
																model.O,
																author$project$Article$metadata(article).bj)
															]))
													]),
												buttons)),
											A2(author$project$Page$viewErrors, author$project$Page$Article$ClickedDismissErrors, model.H)
										]))
								])),
							A2(
							elm$html$Html$div,
													...
													case 2:
														...
														return A2(
															...
															A3(
																...
																slug,
																commentText,
																author$project$Session$viewer(model.am)),
															A2(
																elm$core$List$map,
																A2(author$project$Page$Article$viewComment, model.O, slug),
																comments));
													default:
														return _List_fromArray(
															[
		...
		case 0:
			return {
				bh: elm$html$Html$text(''),
				bC: 'Article'
			};
		case 1:
			return {bh: author$project$Loading$icon, bC: 'Article'};
		default:
			return {
				bh: author$project$Loading$error('article'),
				bC: 'Article'
			};
	}
};
								...
								[
									...
									_List_fromArray(
										[
											...
											elm$html$Html$Attributes$value(fields.bC)
										]),
									_List_Nil)
								])),
							A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											elm$html$Html$Attributes$value(fields.bk)
										]),
									_List_Nil)
								])),
							A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											elm$html$Html$Attributes$value(fields.S)
										]),
									_List_Nil)
								])),
							A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											elm$html$Html$Attributes$value(fields.bB)
										]),
									_List_Nil)
								])),
							saveButton
...
var author$project$Page$Article$Editor$view = function (model) {
	return {
		bh: function () {
			var _n0 = author$project$Session$cred(model.am);
			if (!_n0.$) {
				var cred = _n0.a;
		...
		bC: function () {
			var _n1 = author$project$Page$Article$Editor$getSlug(model.e);
			if (!_n1.$) {
				var slug = _n1.a;
	...
	function (maybeCred, timeZone, article) {
		...
		var faveButton = function () {
			if (!maybeCred.$) {
				var cred = maybeCred.a;
				var _n2 = author$project$Article$metadata(article);
				var favoritesCount = _n2.bo;
				var favorited = _n2.bn;
		...
		var _n0 = author$project$Article$metadata(article);
		var title = _n0.bC;
		var description = _n0.bk;
		var createdAt = _n0.bj;
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							A2(
								...
								author$project$Article$metadata(article).bB))
						]))
				]));
	});
...
var author$project$Article$Feed$viewPagination = F3(
	function (toMsg, page, _n0) {
		...
		var totalPages = author$project$PaginatedList$total(feed.D);
														...
														elm$core$List$concat(
															_List_fromArray(
																[
																	...
																	A2(author$project$Article$Feed$viewArticles, model.O, feed)),
																	_List_fromArray(
																	[
																		A3(author$project$Article$Feed$viewPagination, author$project$Page$Home$ClickedFeedPage, model.ab, feed)
																	])
																])))
													]);
											case 0:
								...
								[
									...
									_List_fromArray(
										[
											...
											A2(elm$core$List$map, author$project$Page$Login$viewProblem, model.B)),
											author$project$Page$Login$viewForm(model.J)
										]))
								]))
						]))
				])),
			...
			switch (_n0.$) {
				case 2:
					...
					var followButton = function () {
						var _n2 = author$project$Session$cred(model.am);
						if (!_n2.$) {
							var cred = _n2.a;
							switch (author.$) {
								case 2:
					...
					return A2(
						...
						_List_fromArray(
							[
								A2(author$project$Page$viewErrors, author$project$Page$Profile$ClickedDismissErrors, model.H),
								A2(
								elm$html$Html$div,
								_List_fromArray(
									[
																	...
																	elm$core$List$concat(
																		_List_fromArray(
																			[
																				_List_fromArray(
																				[
																					author$project$Page$Profile$viewTabs(model.I)
																				]),
																				A2(
																				elm$core$List$map,
																				...
																				_List_fromArray(
																				[
																					A3(author$project$Article$Feed$viewPagination, author$project$Page$Profile$ClickedFeedPage, model.ab, feed)
																				])
																			])))
																]))
														]))
								...
								[
									...
									_List_fromArray(
										[
											...
											A2(elm$core$List$map, author$project$Page$Register$viewProblem, model.B)),
											author$project$Page$Register$viewForm(model.J)
										]))
								]))
						]))
				])),
								...
								[
									...
									_List_fromArray(
										[
											...
											elm$html$Html$Attributes$value(form.E),
								...
								[
									...
									_List_fromArray(
										[
											...
											A2(elm$html$Html$Attributes$attribute, 'rows', '8'),
											elm$html$Html$Attributes$value(form.F),
										...
										[
											...
											_List_fromArray(
												[
													...
													A2(elm$core$List$map, author$project$Page$Settings$viewProblem, model.B)),
													function () {
													var _n1 = model.e;
													switch (_n1.$) {
														case 2:
...
var author$project$Main$main = A2(
	...
	author$project$Viewer$decoder,
	{aD: author$project$Main$init, aM: author$project$Main$ChangedUrl, aN: author$project$Main$ClickedLink, a3: author$project$Main$subscriptions, a7: author$project$Main$update, a8: author$project$Main$view});
